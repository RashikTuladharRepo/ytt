...
<nav id="myNavbar" class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand"><span id="logo-icon" style="font-size: 70px;position: absolute; margin-top: -15px;"></span></a>
            <a class="navbar-brand logo-font">
                <span class="font18">
...
<section class="container-fluid slider" id="slider">
    <ul class="rslides">
        ...
        <li><img src="img/slider-images/slid4.jpg" alt=""></li>
    </ul>
</section>
<!--slider-->
...
<section id="portfolio" class="portfolio visibility-hidden">
    <div class="container-fluid">
        <h2 class="ytt-red"><i class="fa fa-globe">&nbsp;</i>Some of Our Works!</h2>
    </div>
    ...
    <div class="portfolio-descriptions">
        <div class="col-md-2">
            <ul class="nav nav-pills nav-stacked" role="tablist">
                <li role="presentation" class="active"><a href="javascript:void(0)" class="filter ytt-yellow" data-filter="all">All</a></li>
                <li role="presentation"><a href="javascript:void(0)" class="filter ytt-blue" data-filter=".webdevelopment">Web Development</a></li>
                <li role="presentation"><a href="javascript:void(0)" class="filter ytt-red" data-filter=".mobileapp">Mobile Application</a></li>
                <li role="presentation"><a href="javascript:void(0)" class="filter ytt-green" data-filter=".graphics">Graphics</a></li>
                <li role="presentation"><a href="javascript:void(0)" class="filter ytt-blue" data-filter=".contents">Contents Work</a></li>
            </ul>
        </div>
            ...
            <ul class="testimonials-line">
                ...
                <li class="customer">
                    ...
                    <div class="cus-profile">
                        <span class="cus-image"><img src="img/testimonials/te1.jpg"></span>
                     <span class="cus-name">
                         Customer
                ...
                <li class="customer">
                    ...
                    <div class="cus-profile">
                        <span class="cus-image"><img src="img/testimonials/te2.jpg"></span>
                      <span class="cus-name">
                         Customer
                         <span class="cus-title">His title</span>
                      </span>
                ...
                <li class="customer">
                    ...
                    <div class="cus-profile">
                        <span class="cus-image"><img src="img/testimonials/te3.jpg"></span>
                      <span class="cus-name">
                         Customer
                         <span class="cus-title">His title</span>
                      </span>
...
<section id="contact" class="contact visibility-hidden">
    ...
    <div class="container-fluid contact-description">
        <div class="col-md-4">
            ...
            <p><i class="fa fa-location-arrow ytt-red">&nbsp;</i>Kathmandu, Nepal</p>

            <p><i class="fa fa-phone ytt-green">&nbsp;</i>+977-1-9841840193</p>
        ...
        <div class="col-md-4">
            <h3>
                <span class="ytt-green">Find</span>
                <span class="ytt-blue">Us</span>
                <span class="ytt-red">On</span>
            </h3>
...
<footer>
    <p>&nbsp;&nbsp;
        <span class="ytt-green">Young</span>
        <span class="ytt-blue">Thinkers</span>
        <span class="ytt-red">Technology</span> <span class="ytt-yellow">&copy;</span> <span class="ytt-blue">2015</span>
    </p>
</footer>
