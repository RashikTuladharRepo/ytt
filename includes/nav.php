...
<!--                <span id="logo-icon" style="font-size: 70px;position: absolute; margin-top: -15px;"></span>-->
            <img src="img/logo.png" style="margin-left:10px;width:130px; margin-top: -17px;">
            </a>
<!--            <a class="navbar-brand logo-font">-->
<!--                <span class="font18">-->
<!--<!--                    <span class="ytt-green">Young</span>-->
<!--                    <span class="ytt-blue">Kratu</span>-->
