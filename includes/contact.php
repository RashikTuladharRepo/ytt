<section id="contact" class="contact">
    ...
    <div class="container-fluid contact-description">
        ...
        <div class="col-md-4">
            <h3>
                <span class="ytt-green">Send</span>
                <span class="ytt-blue">Us</span>
                <span class="ytt-red">Your</span>
                <span class="ytt-yellow">Feedback</span>
            </h3>
            <div class="social">
                <a href="https://www.facebook.com/KratuTechnology/"><i class="social-icon facebook-hover hvr-float-shadow"><i class="fa fa-facebook"></i></i></a>
